package com.dgtle.lib.drawable.sprite;
...
public class KeyFrameInterpolator implements Interpolator {
    ...
    public static KeyFrameInterpolator pathInterpolator(float controlX1, float controlY1, float controlX2, float controlY2,
                                                        float... fractions)
    {
